...
def file_open():
    ...
    train = pd.read_csv("Data/processed/train_20251128_105750.csv")
    test = pd.read_csv("Data/processed/test_20251128_105750.csv")
    main = pd.read_csv("Data/processed/process_20251128_104710.csv") # 그래프 출력을 위한 파일
